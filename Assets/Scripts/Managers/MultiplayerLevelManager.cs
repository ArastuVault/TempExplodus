...
namespace MoreMountains.TopDownEngine
{
	...
	public class MultiplayerLevelManager : LevelManager
	{
		...
		/// the list of checkpoints (in order) to assign to characters
		[Tooltip("the list of towerblock (in order) to assign to characters")]
		public List<Towerblock> towerBlocks;
		...
		protected override void SpawnMultipleCharacters()
		{
			...
			//	towerBlocks[i].AssignPlayer(Players[i]);
