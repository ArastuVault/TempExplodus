	...
	public class HitscanWeapon : Weapon
	{
		...
		protected virtual void HandleDamage()
		{
			...
			else
			{
				...
				_health.Damage(randomDamage, this.gameObject, Owner.gameObject,DamageCausedInvincibilityDuration, DamageCausedInvincibilityDuration, _damageDirection, TypedDamages);
