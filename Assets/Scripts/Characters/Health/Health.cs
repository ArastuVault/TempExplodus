...
namespace MoreMountains.TopDownEngine
{
	...
	public class Health : MMMonoBehaviour
	{
		...
		public virtual void Damage(float damage, GameObject instigator, GameObject owner ,float flickerDuration, float invincibilityDuration, Vector3 damageDirection, List<TypedDamage> typedDamages = null)
		{
		...
		public virtual void DamageOverTime(float damage, GameObject instigator, GameObject owner,float flickerDuration,
			...
			int amountOfRepeats = 0, float durationBetweenRepeats = 1f, bool interruptible = true, DamageType damageType = null)
		{
			...
			damageOverTime.DamageOverTimeCoroutine = StartCoroutine(DamageOverTimeCo(damage, instigator, owner, flickerDuration,
		...
		/// <param name="damageType"></param>
		/// <returns></returns>
		protected virtual IEnumerator DamageOverTimeCo(float damage, GameObject instigator, GameObject owner, float flickerDuration,
			float invincibilityDuration, Vector3 damageDirection, List<TypedDamage> typedDamages = null,
			int amountOfRepeats = 0, float durationBetweenRepeats = 1f, bool interruptible = true, DamageType damageType = null)
		{
			for (int i = 0; i < amountOfRepeats; i++)
			{
				Damage(damage, instigator, owner, flickerDuration, invincibilityDuration, damageDirection, typedDamages);
